...
╚═════════════╝
${gg} ${exists ? " exists " : "*Thank for Using Aalismuhalat* 💕"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
...
├≽️ !opengrup
╰─────────
${gg} ${exists ? " " : "*Thank for Using Aalismuhalat* 💕"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
}
...
╰───────── ${gg} ${exists ? " " : "*Thank for Using R}`, MessageType.text)
}
...
conn.sendMessage(id, 'Owner Aalismuhalat wa.me/+6282707139276' ,MessageType.text);
}
else if (text == 'Aris'){
conn.sendMessage(id, 'Aku BOT nya Aalismuhalat' ,MessageType.text);
}
...
axios.get(`https://api.banghasan.com/domain/Aalismuhalat/${aris}`).then((res) => {
...
//Tolonglah bro jangan di ubah ubah Aalismuhalat ID
